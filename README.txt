...
and for the GUI in \out\artifacts\ChemicalEquationSolverGUI
To run the .jar file, you can use files ".bat"

The folder "MatLab" contains auxiliary scripts written during the development of the mathematical part of the program.
